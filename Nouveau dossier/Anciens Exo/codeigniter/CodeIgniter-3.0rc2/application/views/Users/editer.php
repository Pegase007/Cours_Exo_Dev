...
<div id='content-wrapper'>
	<h1>Page editer users</h1>


<form action="<?php echo site_url('users/editer/'.$user->id);?>" method='post' class="panel form-horizontal" enctype='multipart/form-data'>
			<div class="panel-heading">
				<span class="panel-title fa fa-plus"> Edition d'utilisateur</span>
			</div>
			<div class="panel-body">
				<div class="row form-group">
					<label class="col-sm-4 control-label">Nom d'utilisateur :</label>
					<div class="col-sm-8">
						<input type="text" name="nom" value='<?php echo $user->username; ?>' class="form-control" placeholder='Nom'>
				...
				<div class="row form-group">
					...
					<div class="col-sm-8">
						<input type="password" name="mdp" value='<?php echo $user->password; ?>' class="form-control" placeholder='Mot de passe'>
				...
				<div class="row form-group">
					...
					<div class="col-sm-8">
						<input type="password" name="mdp1" value='<?php echo $user->password; ?>' class="form-control">
				...
				<div class="row form-group">
					...
					<div class="col-sm-8">
						<input type="email" name="mail" value='<?php echo $user->email; ?>' class="form-control">
				...
				<div class="panel-body form-controls-demo">
					...
					<div class='col-sm-8'>
						<select class="form-control" name='roles' value='<?php echo $user->is_admin; ?>'>
							<option value=''></option>
				...
				<div class='col-sm-8'>
					...
					<img class="col-md-3" src="<?php echo $user->image ?>">
				</div>
			</div>
