...
<h1>Page creer categories</h1>

<!-- 6. $HORIZONTAL_FORM ===========================================================================

				Horizontal form
-->
				<form action="<?php echo site_url('categories/creer');?>" method='post' class="panel form-horizontal" enctype='multipart/form-data'>
					<div class="panel-heading">
						<span class="panel-title fa fa-plus"> Creation de catégorie</span>
					</div>
					<div class="panel-body">
						<div class="row form-group">
							<label class="col-sm-4 control-label">Titre de la categorie:</label>
							<div class="col-sm-8">
								<input type="text" name="title" class="form-control" placeholder='Votre titre'>
					...
					<div class="panel-footer text-right">
						<button type='submit' class="btn btn-primary">Creer cette categorie</button>
					</div>
				</form>
<!-- /6. $HORIZONTAL_FORM -->
